...
public final class VisitaUtil {
    ...
    public static boolean blnHasVisita(
        ...
        VisitaModel visitaModel = VisitaUtil.visServ.visModFindByVisitaId(visitaId_I);
